...
class ExerciciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercicio" do
    assert_difference('Exercicio.count') do
      post exercicios_url, params: { exercicio: { categoria: @exercicio.categoria, name: @exercicio.name, url: @exercicio.url } }
    end
  ...
  test "should update exercicio" do
    patch exercicio_url(@exercicio), params: { exercicio: { categoria: @exercicio.categoria, name: @exercicio.name, url: @exercicio.url } }
